...
describe("fetchCorrectnessData", () => {
  ...
  it("should throw an error if fetching repo details fails", async () => {
    ...
    await expect(
      fetchCorrectnessData("https://github.com/user/repo"),
  ...
  it("should throw an error for an invalid GitHub URL", async () => {
    ...
    await expect(fetchCorrectnessData(invalidUrl)).rejects.toThrow(
  ...
  describe("fetchGitHubData", () => {
    ...
    it("should throw an error for an invalid GitHub URL", async () => {
      ...
      await expect(fetchGitHubData(invalidUrl, endpoint)).rejects.toThrow(
        "Invalid GitHub repository URL",
      );
    });
    ...
    it("should throw an error if the API request fails", async () => {
      ...
      await expect(fetchGitHubData(repoUrl, endpoint)).rejects.toThrow(
