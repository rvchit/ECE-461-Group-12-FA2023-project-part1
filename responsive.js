...
function fetchIssueData(owner, repo, issueNumber) {
    return __awaiter(this, void 0, void 0, function () {
        var apiUrl, response, issueData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiUrl = "https://api.github.com/repos/".concat(owner, "/").concat(repo, "/issues/").concat(issueNumber);
                    return [4 /*yield*/, (0, node_fetch_1.default)(apiUrl, {
                            headers: {
                                Authorization: "Bearer ".concat(process.env.GITHUB_TOKEN),
                            },
...
function responsive(url) {
    return __awaiter(this, void 0, void 0, function () {
        var urlParts, repo, owner, score_list, issues, _i, issues_1, issue, issueData, created, closed_1, diff, median, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    urlParts = url.split("/");
                ...
                case 3:
                    ...
                    issue = issues_1[_i];
                    return [4 /*yield*/, fetchIssueData(owner, repo, issue.number)];
                case 4:
                    issueData = _a.sent();
                    created = parseDate(issue.created_at);
                    closed_1 = parseDate(issueData.closed_at);
                ...
                case 7:
                    ...
                    throw error_1; // Re-throw the error to be caught by the caller
